...
<div style="max-width:560px;margin:0 auto;padding:20px;">
  ...
  <div style="padding:32px 0 20px;">
    ...
    <p style="font-size:14px;color:#8a7f78;line-height:1.8;margin:0 0 12px;font-family:sans-serif;">
      Ευχαριστούμε για την κράτησή σας στο <strong style="color:#c09a68;">Tower 15 Suites</strong>!
  ...
  <div style="text-align:center;padding:28px 0;">
    <a href="${checkinUrl}" style="display:inline-block;background:#8B5E2A;color:white;text-decoration:none;padding:16px 40px;font-family:sans-serif;font-size:15px;letter-spacing:0.08em;text-transform:uppercase;">
      Έναρξη Online Check-In →
    </a>
    <p style="font-family:sans-serif;font-size:11px;color:#4a4744;margin:12px 0 0;">
      Ή αντιγράψτε: <span style="color:#8a7f78;">${checkinUrl}</span>
    </p>
  </div>
  <div style="background:#1a1816;border:1px solid #3d3935;padding:24px;margin-bottom:24px;">
    ...
    <div style="font-family:sans-serif;font-size:13px;color:#8a7f78;line-height:1.8;">🪪 Αστυνομική ταυτότητα ή διαβατήριο<br>📧 Email για τους κωδικούς<br>⏱️ Διαρκεί μόνο 2–3 λεπτά</div>
  </div>
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (body.reservationId) {
      ...
      // ── Batch/cron mode: D-2 fallback για κρατήσεις χωρίς link ──────────────
